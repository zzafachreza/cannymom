                        ...
                        <View style={{}}>
                            <View style={{ padding: 10 }}>
                                <Text style={{ fontFamily: fonts.primary[400], fontSize: 12, textAlign: "justify", color: colors.tekscolor }}>
                                    ...
                                    4. Darah haidh tidak membeku, sedangkan darah istihadhah bisa membeku.tika sudah Sembilan bulan, saat sedang sakit sekali hingga sulit untuk keluar bayinya yakni membaca doa{'\n'}
                                </Text>
                            </View>
