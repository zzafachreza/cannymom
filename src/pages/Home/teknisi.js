...
export default function TeknisiHome({ navigation, route }) {
  ...
  <View style={{padding:10}}>
    ...
    <View style={{padding:10}}>
      ...
      <TouchableNativeFeedback onPress={() => navigation.navigate('TeknisiRiwayatPemesanan')}>
        <View style={{padding:10, borderWidth: 0.4, borderRadius:10, flexDirection:"row" ,
