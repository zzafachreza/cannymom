            ...
            <ScrollView>
                <View style={{ padding: 10, }}>
                    ...
                    <TouchableNativeFeedback onPress={() => navigation.navigate("Kalender")}>
                        <View style={{ padding: 10, borderColor: colors.border, borderRadius: 10, flexDirection: "row", borderWidth: 1, justifyContent: 'center' }}>
                    ...
                    <TouchableNativeFeedback onPress={() => navigation.navigate("Cheklist")}>
                        <View style={{ padding: 10, borderRadius: 10, flexDirection: "row", borderWidth: 1, borderColor: colors.border, justifyContent: 'center' }}>
