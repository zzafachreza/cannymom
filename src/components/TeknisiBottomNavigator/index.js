...
export default function TeknisiBottomNavigator({ state, descriptors, navigation }) {
  ...
  return (
    <View style={{ backgroundColor: colors.white, flexDirection: 'row',  borderTopLeftRadius:20, borderTopRightRadius:20, marginTop:-50}}>
